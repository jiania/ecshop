...
-- 添加系统保留的会员注册项信息
INSERT INTO `ecs_reg_fields` (`id`, `reg_field_name`, `dis_order`, `display`, `type`, `is_need`) VALUES (1, 'MSN', 0, 1, 1, 1), (2, 'QQ', 0, 1, 1, 1), (3, '辦公電話', 0, 1, 1, 1), (4, '家庭電話', 0, 1, 1, 1), (5, '手機', 0, 1, 1, 1), (6, '密碼找回問題', 0, 1, 1, 1);
