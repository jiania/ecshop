...
UPDATE `ecs_template` SET region = '導航欄下方左側' WHERE region = 'navigatorBottomLeft';
UPDATE `ecs_template` SET region = '導航欄下方右側' WHERE region = 'navigatorBottomRight';
UPDATE `ecs_template` SET region = '主區域左側' WHERE region = 'mainLeft';
UPDATE `ecs_template` SET region = '主區域右側' WHERE region = 'mainRight';
UPDATE `ecs_template` SET region = '主區域中間部分' WHERE region = 'mainCenter';
UPDATE `ecs_template` SET region = '主區域頂部' WHERE region = 'mainTop';
INSERT INTO `ecs_template` (`filename`, `region`, `library`, `sort_order`, `id`, `number`, `type`) VALUES 
('receive', '導航欄下方左側', '/library/ur_here.lbi', 0, 0, 5, 0),
('receive', '導航欄下方右側', '/library/search_form.lbi', 0, 0, 5, 0),
('tag_cloud', '導航欄下方左側', '/library/ur_here.lbi', 0, 0, 5, 0),
('tag_cloud', '導航欄下方右側', '/library/search_form.lbi', 0, 0, 5, 0),
('tag_cloud', '主區域左側', '/library/category_tree.lbi', 0, 0, 5, 0),
('tag_cloud', '主區域左側', '/library/cart.lbi', 1, 0, 5, 0),
('tag_cloud', '主區域左側', '/library/history.lbi', 2, 0, 5, 0),
('tag_cloud', '主區域右側', '/library/tag_list.lbi', 0, 0, 5, 0),
('advanced_search', '導航欄下方左側', '/library/ur_here.lbi', 0, 0, 5, 0),
('advanced_search', '導航欄下方右側', '/library/search_form.lbi', 0, 0, 5, 0),
('advanced_search', '主區域左側', '/library/cart.lbi', 0, 0, 5, 0),
('advanced_search', '主區域左側', '/library/top10.lbi', 1, 0, 5, 0),
('advanced_search', '主區域左側', '/library/history.lbi', 2, 0, 5, 0),
('advanced_search', '主區域中間部分', '/library/search_advanced.lbi', 0, 0, 5, 0),
('catalog', '導航欄下方左側', '/library/ur_here.lbi', 0, 0, 5, 0),
('catalog', '導航欄下方右側', '/library/search_form.lbi', 0, 0, 5, 0),
('pick_out', '導航欄下方左側', '/library/ur_here.lbi', 0, 0, 5, 0),
('pick_out', '導航欄下方右側', '/library/search_form.lbi', 0, 0, 5, 0),
('pick_out', '主區域左側', '/library/pickout.lbi', 0, 0, 5, 0),
('pick_out', '主區域右側部分', '/library/your_picking.lbi', 0, 0, 5, 0),
('pick_out', '主區域右側部分', '/library/cart.lbi', 1, 0, 5, 0),
('pick_out', '主區域右側部分', '/library/top10.lbi', 2, 0, 5, 0);